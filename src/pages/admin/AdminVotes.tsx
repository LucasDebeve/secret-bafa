  ...
  return (
    <div className="card">
      <div className="card-head">
        ...
        <span className="badge badge-blue">+3 pts si correct · +1 pt defense automatique</span>
      </div>
            ...
            {!cV.length ? (
              ...
              return (
                <tr key={v.id} style={v.validated ? { opacity: 0.55 } : undefined}>
                  ...
                  <td>
                    {v.validated
                      ? v.adminValidated ? <span className="badge badge-green">+3 pts</span> : <span className="badge badge-red">Refuse</span>
                      : v.correct ? <span className="badge badge-blue">Correct</span> : <span className="badge badge-amber">Incorrect</span>}
                  </td>
                  <td>
                    {v.validated ? (
